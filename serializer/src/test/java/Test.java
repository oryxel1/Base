...
public class Test {
    public static void main(String[] args) {
        ...
        try {
            Types.SCENARIO_TYPE.write(scenario.build(), buf);
            Scenario scenario1 = Types.SCENARIO_TYPE.read(buf);
            Launcher.launch(new ScenarioScreen(scenario1), false);
        } finally {
            buf.release();
        }
