...
public class TestScreen extends Screen {
    ...
    public void init() {
        ...
        this.components.add(new ClickableComponent(5, 300, (int) size2.x, (int) size2.y, () -> {
            Launcher.WINDOW.setCurrentScreen(new Screen() {
                ...
                public void init() {
                    ...
                    this.components.add(new ClickableComponent(5, 100, (int) size1.x, (int) size1.y, () -> {
                        Launcher.WINDOW.setCurrentScreen(new TestScreen());
                    }) {
                        @Override
                        public void render(int width, int height, double mouseX, double mouseY) {
                            super.render(width, height, mouseX, mouseY);
