package oxy.bascenario.utils.drag;
...
import oxy.bascenario.editor.containers.oldstuff.object.ObjectComponent;
import oxy.bascenario.editor.containers.oldstuff.track.TrackContainer;
    ...
    public void render(Renderer renderer, Size size) {
        for (Data data : list) {
            renderer.translate(mouseX + data.offsetX, mouseY + data.offsetY, () -> {
                float width = timelineContainer.screen().oneMilSecondWidth() * data.object.object().duration;
