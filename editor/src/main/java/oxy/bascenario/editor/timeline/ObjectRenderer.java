...
//        final float x = pos.x + size.x / 4, width = size.x - (size.x / 4);
//        final float y = pos.y + 80 + (object.trackId * 50);
//
...
//            timeline.getScreen().setDragging(null);
//            return;
//        }
//
...
//        }
//
//        boolean here = (timeline.getScreen().getDragging() == null || timeline.getScreen().getDragging() == this);
//
...
//            timeline.getScreen().setDragging(this);
//            return;
//        }
//
//        if (oldDrag) {
...
//        }
//
//        if (timeline.getScreen().getDragging() == this) {
//            timeline.getScreen().setDragging(null);
//        }
//    }
//
