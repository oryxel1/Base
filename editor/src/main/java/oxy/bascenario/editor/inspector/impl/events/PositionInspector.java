...
public class PositionInspector {
    public static RotateElementEvent render(RotateElementEvent event) {
        ...
        float x = ImGuiUtils.sliderFloat("X", (int) event.rotation().x(), 0, 360);
        float y = ImGuiUtils.sliderFloat("Y", (int) event.rotation().y(), 0, 360);
        float z = ImGuiUtils.sliderFloat("Z", (int) event.rotation().z(), 0, 360);
    ...
    public static PositionElementEvent render(PositionElementEvent event) {
        ...
        float x = ImGuiUtils.sliderFloat("X", (int) event.vec().x(), MIN_X, MAX_X);
        float y = ImGuiUtils.sliderFloat("Y", (int) event.vec().y(), MIN_Y, MAX_Y);
