...
public class ObjectComponent extends Component {
    ...
    public void render(Renderer renderer, Size bounds) {
        ...
        this.parent.selectionManager().addIfIntersects(this, parent().childBounds(this));
    }
    ...
    protected boolean onComponentMouseMove(MouseMoveEvent event, Size size) {
        ...
        final SecondaryDragComponent dragComponent = new SecondaryDragComponent(parent.timelineContainer(), (float) Launcher.WINDOW.mouseX, (float) Launcher.WINDOW.mouseY, list);
