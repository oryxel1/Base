package oxy.base.editor.containers.assets;
...
import oxy.base.editor.containers.assets.object.ObjectContainer;
...
public class AssetsContainer extends GlobalContainer.ResizeableContainer {
    public AssetsContainer() {
        ...
        add(new PaddedContainer(new Padding(10, 10, 0, 0), new ObjectContainer()), c -> c.layoutOptions(DockPosition.CENTER));
    }
