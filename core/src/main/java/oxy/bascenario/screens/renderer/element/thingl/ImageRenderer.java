...
public class ImageRenderer extends ThinGLElementRenderer<RendererImage> {
    ...
    public ImageRenderer(RendererImage element, RenderLayer layer, Scenario scenario) {
        super(element, layer);
        this.texture2D = TextureManager.getInstance().getTexture(scenario, element.image().file());
    }
