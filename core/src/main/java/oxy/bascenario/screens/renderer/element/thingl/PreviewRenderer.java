...
public class PreviewRenderer extends ThinGLElementRenderer<Preview> {
    ...
    private void renderBackground() {
        if (element.background() != null) {
            ...
            ThinGLUtils.blurRectangle(0, 0, ThinGL.windowInterface().getFramebufferWidth(), ThinGL.windowInterface().getFramebufferHeight(), Math.round(9 * this.globalFade.getValue())); // Very nice blur thanks to ThinGL.
