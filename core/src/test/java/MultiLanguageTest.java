...
//        scenario.add(0, new StartDialogueEvent(FontType.NotoSans, 0, "Kayoko", "Problem Solver 68", true,
...
//
//        scenario.add(true, 0, new StartDialogueEvent(FontType.ShinMaruGo, 0, "加代子", "問題解決者68", true,
